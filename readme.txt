...
Tags: Menu, Sidebar, layout, custom, front page, customize, page, site, images, image, admin, theme, background, CSS, idebar, widget, widgets
...
2. For each menu item a page need to be created. Click "Add new page" and upload a image or 2 images for image swap 
...
format http://.. alternatively add 0 (zero) for no link at all or 1 to link to the page. When you have added this field 

and published the page the menu will now recognize this page as a menu item and be visible in the Menu Widget 1 

section. For widget 2 use "link2" and for widget 3 use "link3" etc.
